    ...
    while True:
        ...
        if now.minute % 1 == 0 :
            try:
                ...
                spech_search_instance = spech_search_through_directory(audio_path = 'drive1/new_audio_server/audio_search/data/', directoryPath = 'data1/', saving_path = 'data1/', wav2vec_model = wav2vec_model, wav2vec_tokenizer = wav2vec_tokenizer, semantic_model = semantic_model, semantic_tokonizer = semantic_tokonizer, f = 6, i = 1)
